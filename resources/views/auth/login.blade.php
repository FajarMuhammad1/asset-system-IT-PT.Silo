...
<head>
    ...
    <title>Resource asset system - Login</title>
...
<body class="bg-gradient-primary">
    ...
    <script src="{{ asset('v/sbadmin2endor/jquery/jquery.min.js') }}"></script>
    <script src="{{ asset('v/sbadmin2endor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
